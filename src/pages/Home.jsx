...
import img1 from "../assets/business-people-meeting-looking-presentation.jpg";
import img2 from "../assets/futuristic-business-scene-with-ultra-modern-ambiance.jpg";
import img3 from "../assets/group-people-working-out-business-plan-office.jpg";
import img4 from "../assets/abt (1).jpg";
import img5 from "../assets/abt (2).jpg";
    ...
    <>
      ...
      <div className="w-full relative h-screen">
        <Swiper
          ...
          className="progress-slide-carousel relative h-full"
        >
          <SwiperSlide>
            <div className="relative h-screen flex justify-center items-center">
              ...
              {/* Overlay content */}
              <div
                className="relative text-center z-10 text-white p-6"
                style={{
                  width: "650px",
